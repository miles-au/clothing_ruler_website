...
function PrivacyPolicy() {
    return (
        <div className="privacy-policy-page container">
            ...
            <p>This Privacy Policy explains how Kyle Au ("us," "we," or "our") collects, uses, and discloses information obtained through the "Clothing Ruler" mobile application ("the App") when you use our services.</p>
            ...
            <section>
              ...
              <p>If you have any questions about this Privacy Policy or the use of your data, please contact us at miles.d.au@gmail.com.</p>
            </section>
